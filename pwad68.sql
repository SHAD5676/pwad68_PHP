...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2025 at 01:13 PM
...
--
-- Table structure for table `prodects1`
--

CREATE TABLE `prodects1` (
  `id` int(11) NOT NULL,
...
(1, 'gdfghdfh', 'shad@gmail.com', '01766754657', 'dfgfdhgfh'),
(2, 'dsfd', 'gh@ggjy.com', '016767564564', 'trfgdgfdh'),
(3, 'Shad', 'Jannat', 'Dhaka', 'Bangladesh'),
(4, 'aa', 'fdd', 'hg', 'fvfgy'),
(5, 'fds', 'hg', 'jnbhj', 'juhu'),
(6, 'asd', 'vd', 'zxdcv', 'we'),
(7, 'Jannat', 'Shad', '0011-11-11', 'cvxv'),
(8, 'Jannat', 'Shad', '0011-11-11', 'sdfsf'),
(9, 'Jannat', 'Shad', '0011-11-11', 'cvx'),
(10, 'Jannat', 'Shad', '0011-11-11', 'cvx'),
(11, 'Jannat', 'Shad', '0011-11-11', 'cvx'),
(12, 'Jannat', 'Shad', '0011-11-11', 'cvx');
...
INSERT INTO `students1` (`employeeID`, `first_name`, `last_name`, `birthdate`, `notes`) VALUES
...
(11, 'Jannat', 'Shad', '2025-11-19', 'xc'),
(12, 'Jannat', 'Shad', '2025-11-19', 'szxd'),
(13, 'Jannat', 'Shad', '2025-11-05', 'xc'),
(14, 'Jannat', 'Shad', '2025-11-19', 'ZdX'),
(15, 'Jannat', 'Shad', '2025-11-19', 'Sz');
...
--
-- Indexes for table `prodects1`
--
ALTER TABLE `prodects1`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `prodects1`
--
ALTER TABLE `prodects1`
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`employeeID`) REFERENCES `students1` (`employeeID`),
